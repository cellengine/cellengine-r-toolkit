...
test_that("Correct HTTP request is made", {
  with_mock(
    `httr::request_perform` = function(req, handle, refresh) {
      ...
      expect_match(body, '{"model":{"locked":false,"split":{"x":144000,"y":0.5},"gids":\\["[0-9A-Za-z]{24}","[0-9A-Za-z]{24}"\\],"labels":\\[\\[26215.4,0.95\\],\\[235929.6,0.95\\]\\]},"xChannel":"FSC-A","type":"SplitGate","names":\\["my gate \\(L\\)","my gate \\(R\\)"\\],"gid":"[0-9A-Za-z]{24}","tailoredPerFile":false,"fcsFileId":null}', perl = T) # nolint
      response <- httptest::fake_response(
        req$url,
        req$method,
        # Fixed GID, not the one passed in
        content = '{"__v":0,"experimentId":"591a3b441d725115208a6fda","model":{"locked":false,"labels":[[26215.4,0.95], [235929.6, 0.95]],"split":{"x":144000,"y":0.5},"gids":["5d30960a417e4bc767a428a3","5d30960a417e4bc767a428a4"]},"gid":"592640a5a6a1d6256ec9b08a","xChannel":"FSC-A","type":"SplitGate","name":"my gate","_id":"592640aa298f1480900e10e4","tailoredPerFile":false}', # nolint
        status_code = 201,
...
test_that("Correct HTTP request is made, fcsFileId specified", {
  with_mock(
    `httr::request_perform` = function(req, handle, refresh) {
      ...
      body <- rawToChar(req$options$postfields)
      # Literal except for the gid values
      expect_match(body, '{"model":{"locked":false,"split":{"x":144000,"y":0.5},"gids":\\["[0-9A-Za-z]{24}","[0-9A-Za-z]{24}"\\],"labels":\\[\\[26215.4,0.95\\],\\[235929.6,0.95\\]\\]},"xChannel":"FSC-A","type":"SplitGate","names":\\["my gate \\(L\\)","my gate \\(R\\)"\\],"gid":"[0-9A-Za-z]{24}","tailoredPerFile":true,"fcsFileId":"591a3b441d725115208a6fdf"}', perl = T) # nolint
      response <- httptest::fake_response(
        req$url,
        req$method,
        # Fixed GID, not the one passed in
        content = '{"__v":0,"experimentId":"591a3b441d725115208a6fda","model":{"locked":false,"labels":[[26215.4,0.95], [235929.6, 0.95]],"split":{"x":144000,"y":0.5},"gids":["5d30960a417e4bc767a428a3","5d30960a417e4bc767a428a4"]},"gid":"592640a5a6a1d6256ec9b08a","xChannel":"FSC-A","type":"SplitGate","name":"my gate","_id":"592640aa298f1480900e10e4","tailoredPerFile":true,"fcsFileId":"591a3b441d725115208a6fdf"}', # nolint
        status_code = 201,
        headers = list(`Content-Type` = "application/json")
      )
      return(response)
      ...
      switch(req$url,
        ...
        "https://my.server.com/api/v1/experiments/591a3b441d725115208a6fda/gates?createPopulation=true&parentPopulationId=591a3b5f1d725115208a7087" = { # nolint
          ...
          response <- httptest::fake_response(
            ...
            # Fixed GID, not the one passed in
            content = '{
              "gate": {"__v":0,"experimentId":"591a3b441d725115208a6fda","model":{"locked":false,"labels":[[26215.4,0.95], [235929.6, 0.95]],"split":{"x":144000,"y":0.5},"gids":["5d30960a417e4bc767a428a3","5d30960a417e4bc767a428a4"]},"gid":"592640a5a6a1d6256ec9b08a","xChannel":"FSC-A","type":"SplitGate","name":"my gate","_id":"592640aa298f1480900e10e4","tailoredPerFile":false,"fcsFileId":null},
              "populations": [
                ...
                {"parentId":"591a3b5f1d725115208a7087","_id":"62fc44da8500a029b981e351","name":"my gate","gates":"{\\"$and\\":[\\"591a3b5961a8a2302d15a33a\\",\\"5d30960a417e4bc767a428a4\\"]}","terminalGateGid":"5d30960a417e4bc767a428a4","experimentId":"591a3b441d725115208a6fda"}
              ]
            }', # nolint
            status_code = 201,
            headers = list(`Content-Type` = "application/json")
